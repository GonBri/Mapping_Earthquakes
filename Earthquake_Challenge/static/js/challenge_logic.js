...
// Deliverable 3 : We create the thrid tile layer that will be the background of our map.
...
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(gitdata) {
  L.geoJson(gitdata, {
    color: "#f03b20",
    weight: 2
